...
def get_custom_workflow_documentation() -> str:
    """This function provides documentation with instructions on how to configure Nodes when
    ...
    - The order of the nodes in the workflow_nodes array will be the same order that these nodes
    appear in the DAG, with the first node in the array added directly after the Source node.
...
custom_workflow_message = """
In order to create a workflow of type 'custom', you need to first execute
get_custom_workflow_documentation tool to get the specifics of how to configure the nodes.
"""


def add_custom_workflow_message(func):
    if func.__doc__ is None:
        func.__doc__ = ""
    func.__doc__ = f"{custom_workflow_message}\n{func.__doc__}"
    return func
